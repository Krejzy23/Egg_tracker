  ...
  return (
    <SafeAreaView className="flex-1 bg-zinc-50">
      <View className="flex-1 px-5 pt-4 pb-24">
        ...
        <Pressable
          onPress={() => navigation.navigate("FlockProfile")}
          className="rounded-[28px] bg-amber-50 px-5 py-5 shadow-lg mt-4"
        >
          <View className="flex flex-row justify-between">
            <View className="flex flex-col">
              ...
              <Text className="mt-2 text-sm text-zinc-500 max-w-48">
                {t("home.flockSubTitle")}
              </Text>
            </View>
            <View>
              <Image
