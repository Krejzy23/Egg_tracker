        ...
        <View className="px-5 pt-4">
          ...
          <View className="gap-4">
            <View className="flex-row gap-4">
              ...
              />
              <StatCard
                label={t("stats.cards.brokenEggs")}
                value={stats.totalBrokenEggs.toString()}
              />
            </View>
          ...
          <View className="mt-6 px-4 py-2">
            ...
            <View className="flex-row -mt-4 gap-4 px-4">
              <View className="flex-row items-center">
                <View className="mr-2 h-3 w-3 rounded-full bg-blue-600" />
          ...
          <View className="mt-4 gap-4">
            <View className="flex-row gap-4">
              <InfoCard
                ...
                secondaryValue={
                  extraStats.bestDay
                    ? `${extraStats.bestDay[1].eggs} ${t("stats.extra.eggsSuffix")}`
                    : ""
                }
              />
              ...
              <InfoCard
                ...
                secondaryValue={
                  extraStats.worstDay
                    ? `${extraStats.worstDay[1].eggs} ${t("stats.extra.eggsSuffix")}`
                    : ""
                }
              />
            </View>
