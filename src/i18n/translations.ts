export const translations = {
  cs: {
    home: {
      ...
      logout: "Odhlásit se",
      flockTitle:"Moje Hejno",
      flockSubTitle:"Spravuj skupiny slepic podle plemene, barvy a data pořízení",
    ...
    addEggs: {
      ...
      brokenEggs: "Z toho rozbitých",
      brokenEggsSubtitle: "Pouze statistika, nesnižuje celkový počet snesných vajec",
    ...
    //LOGIN ALERTS
    login: {
      mainText: "Záznam slepičích vajec",
    ...
    flock: {
      title: "Moje hejno",
      subtitle: "Skupiny slepic podle plemene, barvy a data pořízení",

      overview: "Přehled hejna",
      total: "slepice celkem",
      groups: "skupin",

      addGroup: "Přidat skupinu",
      breed: "Plemeno / název skupiny",
      color: "Barva",
      acquiredDate: "Datum pořízení",
      count: "Počet slepic",
      note: "Poznámka",
      save: "Uložit skupinu",

      emptyTitle: "Zatím žádné skupiny",
      emptySubtitle: "Přidej první skupinu slepic",

      chickens: "slepice",
      colorLabel: "Barva",
      acquiredLabel: "Pořízeno",
      otherBreed: "Jiné",
      editGroup: "Upravit skupinu",
      editGroupCancel: "Zrušit Editaci",
      ageLabel: "Stáří",
      months: "měsíců",

      alerts: {
        missingBreed: "Vyplň prosím plemeno nebo název skupiny.",
        invalidCount: "Počet slepic musí být větší než 0."
      }
    },
  },
  ...
  en: {
    home: {
      ...
      flockTitle:"My Flock",
      flockSubTitle:"Manage groups of hens by breed, color and date of acquisition",
    ...
    addEggs: {
      ...
      eggCount: "Egg count",
      brokenEggs: "Broken eggs",
      brokenEggsSubtitle: "Tracked separately, does not reduce total layed egg count",
    ...
    login: {
      mainText: "Tracking chicken eggs",
    ...
    flock: {
      title: "My flock",
      subtitle: "Chicken groups by breed, color and acquisition date",

      overview: "Flock overview",
      total: "chickens total",
      groups: "groups",

      addGroup: "Add group",
      breed: "Breed / group name",
      color: "Color",
      acquiredDate: "Acquired date",
      count: "Number of chickens",
      note: "Note",
      save: "Save group",

      emptyTitle: "No groups yet",
      emptySubtitle: "Add your first chicken group",
      ...
      alerts: {
        missingBreed: "Please enter breed or group name.",
        invalidCount: "Chicken count must be greater than 0."
      }
    }
  },
} as const;